...
* 函数功能		   ：LCD显示汉字函数
*******************************************************************************/
void LCD_ShowChinese1(u16 x,u16 y,u8 size,u16 color,u16 N)	
{  
	u8 i,j,index;
	u8 *temp,size1;
	temp=chinese;
	switch(N)
	{
		case 45493:index=0;break;
		case 45255:index=1;break;
		case 43735:index=2;break;
		case 55755:index=3;break;
		case 59593:index=4;break;
		case 43190:index=5;break;
		case 51133:index=6;break;
		case 51382:index=7;break;
		case 53714:index=8;break;
		case 47779:index=9;break;
	}
...
void Clear_WaveA()
{
	...
	LCD_DrawLine(1,85,4,80,YELLOW);
	LCD_DrawLine(4,80,7,85,YELLOW);
...
void Clear_WaveB()
{
	LCD_Fill(5,40,125,125,WHITE);
  LCD_DrawLine(1,45,4,40,YELLOW);
	LCD_DrawLine(4,40,7,45,YELLOW);
	LCD_DrawLine(4,40,125,20,YELLOW);
	LCD_DrawLine(4,125,125,125,YELLOW);//lcd显示B界面
	x=6;
}
/*******************************************************************************
* 函数功能		   ：LCD画圆函数
...
void LCD_ShowB()
{
	LCD_Clear(WHITE);
	BACK_COLOR=WHITE;//清屏
	my_printf_lcd(4,0,"已转角度:  0\n设定角度:\n");
	my_printf_lcd(80,20,"%d",Set_Angle);
	LCD_DrawLine(1,45,4,40,YELLOW);
	LCD_DrawLine(4,40,7,45,YELLOW);
	LCD_DrawLine(4,40,4,125,YELLOW);
	LCD_DrawLine(4,40,125,20,YELLOW);
	LCD_DrawLine(4,125,125,125,YELLOW);//lcd显示B界面
}
