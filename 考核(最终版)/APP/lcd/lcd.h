...
#define OLED_RES_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_8)//RES
#define OLED_RES_Set() GPIO_SetBits(GPIOC,GPIO_Pin_8)

#define OLED_DC_Clr() GPIO_ResetBits(GPIOD,GPIO_Pin_7)//DC
...
#define OLED_BLK_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_5)//BLK
#define OLED_BLK_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_5)
...
extern u16 Set_Angle;
extern u16 x;

void Clear_WaveA(void);
void Clear_WaveB(void);
